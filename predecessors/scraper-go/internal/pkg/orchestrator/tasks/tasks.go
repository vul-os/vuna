...
func (t *TaskCreator) CreateTaskProduct(url, scraperCode, scheduledTime time.Time, proxy string) error {
	taskURL := fmt.Sprintf("%s/scraper/product/%s", t.TargetURL, url)
